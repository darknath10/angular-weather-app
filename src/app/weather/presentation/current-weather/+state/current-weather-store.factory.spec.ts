...
import { CurrentWeatherState, CurrentWeatherStore, currentWeatherStoreFactory } from './current-weather-store.factory';
...
describe('Current Weather Store', () => {
  ...
  beforeEach(() => {
    componentStore = new ComponentStore<CurrentWeatherState>({ loading: false, weather: null });
    currentWeatherGw = () => of(currentWeather);
    store = currentWeatherStoreFactory(componentStore, currentWeatherGw, snackbar);
  });
